...
| A10 | Tests: schema, merge, fake provider, integration + **e2e** for CLI (`bun test`) | Partial (`init`/`doctor`/`ping`/`plan` e2e; full plan→execute→review pipeline e2e in A6–A8) |
